...
<body>
    <h2>Add new shoe details</h2>
    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
        <div class="div1">
        
        <label for="shoename">shoename:</label><br>
        <input type="text" id="shoename" name="shoename" placeholder="enter shoename" required><br>
        <label for="brand">brand:</label><br>
        <input type="text" id="brand" name="brand" placeholder="enter brand" required><br>
        <label for="color">color:</label><br>
        <input type="text" id="color" name="color" placeholder="choose your color" required><br>
